...
<%@page import="kr.qtorder.model.NoticeVO"%>
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main class="bg-color">
                        ...
                        <div class="page-header-content">
                            <div class="row align-items-center justify-content-between pt-3">
                                ...
                                <div class="col-12 col-xl-auto mb-3">
                                    <a class="btn btn-sm btn-light text-primary text-color" href="GonoticeList.do">
                ...
                <input type="hidden" name="ft_dix" value="${login_idx}">
                <div class="container-fluid px-4">
                    <div class="row gx-4">
                        <div class="col-lg-8">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                	<input class="form-control" id="postTitleInput" name="postTitleInput" type="text" placeholder="Enter your post title..." />
                                </div>
                            </div>
                            ...
                            <div class="card card-header-actions mb-4 mb-lg-0">
                                ...
                                <div class="card-body">
                                    <textarea id="postEditor" name="postContent"></textarea>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-lg-4">
                            <div class="card card-header-actions">
                                ...
                                <div class="card-body">
                                    <div class="d-grid">
                                    	<button type="submit" class="fw-500 btn btn-primary text-color">공지사항 등록하기</button>
                                    </div>
                                </div>
                            </div>
                        </div>
